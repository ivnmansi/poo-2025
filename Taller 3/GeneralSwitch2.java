...
public class GeneralSwitch2
{
    ...
    public void button(){
        ...
        for(int i=0;i<artefacto.size();i++){
            if(switchState && artefacto.get(i).getArtefactoSwitch()){
                ...
                consumoTotal = consumoTotal + artefacto.get(i).getConsumo();
            }
            else {
    ...
    /**
     * Getter para el numero de artefactos
     */
    ...
    /**
     * Setter para el numero de artefactos
     */
    ...
    /** 
     * Getter para el consumo total
     */
    public int getConsumoTotal(){
        return consumoTotal;
    }
    /**
     * Setter para el consumo total
     */
    public void setConsumoTotal(int num){
        consumoTotal = num;
    }
